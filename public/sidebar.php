        ...
        <div class="page-sidebar">
            <ul>
                ...
                <li class="sticker sticker-color-orange dropdown active" data-role="dropdown">
                    ...
                    <ul class="sub-menu light sidebar-dropdown-menu keepOpened open">
                ...
                <li class="sticker sticker-color-green dropdown active" data-role="dropdown">
                    <a><i class="icon-list"></i> List opened</a>
                    <ul class="sub-menu light sidebar-dropdown-menu keepOpened">
                        <li><a href="">Item 1</a></li>
                        <li><a href="">Item 2</a></li>
                        <li><a href="">Item 3</a></li>
                        <li><a href="">Item 4</a></li>
...
<pre class="prettyprint linenums">
    ...
    &lt;/div&gt;
                    ...
                    <p>
                        You can add <code>keepOpened</code> class to sub-menu to prevent default collapsing of menu.
                    </p>
<pre class="prettyprint linenums">
    &lt;div class="page-sidebar"&gt;
        &lt;ul&gt;
            &lt;li&gt;
                &lt;a&gt;Item&lt;/a&gt;
                &lt;ul class="sub-menu sidebar-dropdown-menu keepOpened"&gt;
                ...
                &lt;/ul&gt;
            &lt;/li&gt;
            ...
