(function($) {
    ...
    if (globalThis.METRO_DEBUG === undefined) {globalThis.METRO_DEBUG = true;}
    ...
    if (globalThis.METRO_DATE_FORMAT_INPUT === undefined) {
        globalThis.METRO_DATE_FORMAT_INPUT = meta_date_format_input !== undefined ? meta_date_format_input : "YYYY-MM-DD";
    }
    ...
    if (globalThis.METRO_ANIMATION_DURATION === undefined) {
        globalThis.METRO_ANIMATION_DURATION = meta_animation_duration !== undefined ? parseInt(meta_animation_duration) : 100;
    }
    ...
    if (globalThis.METRO_HOTKEYS_FILTER_CONTENT_EDITABLE === undefined) {globalThis.METRO_HOTKEYS_FILTER_CONTENT_EDITABLE = true;}
    if (globalThis.METRO_HOTKEYS_FILTER_INPUT_ACCEPTING_ELEMENTS === undefined) {globalThis.METRO_HOTKEYS_FILTER_INPUT_ACCEPTING_ELEMENTS = true;}
    if (globalThis.METRO_HOTKEYS_FILTER_TEXT_INPUTS === undefined) {globalThis.METRO_HOTKEYS_FILTER_TEXT_INPUTS = true;}
    if (globalThis.METRO_HOTKEYS_BUBBLE_UP === undefined) {globalThis.METRO_HOTKEYS_BUBBLE_UP = false;}
    if (globalThis.METRO_THROWS === undefined) {globalThis.METRO_THROWS = true;}
