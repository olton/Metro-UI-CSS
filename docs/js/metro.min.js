...
break;case "slide":c(a).slideUp("fast");break;default:c(a).hide()}this._trigger("onClose",null,a)},_destroy:function(){},_setOption:function(a,b){this._super("_setOption",a,b)}})})(jQuery);
(function(c){c.fn.PullDown=function(a){var b={},d=c(this),e=function(a){addTouchEvents(a[0]);a.on("mousedown",function(a){a.preventDefault();a.stopPropagation();a=d.parent().find(".element-menu");"block"==a.css("display")?a.slideUp("fast"):a.slideDown("fast")})};return this.each(function(){a&&c.extend(b,a);e(d)})};c(function(){c(".pull-menu, .menu-pull").each(function(){c(this).PullDown()})})})(window.jQuery);(function(c){c.widget("metro.inputControl",{version:"1.0.0",options:{},_create:function(){var a=this.element;a.hasClass("text")?this.initTextInput(a,this):a.hasClass("password")?this.initPasswordInput():a.hasClass("checkbox")||a.hasClass("radio")||a.hasClass("switch")?this.initCheckboxInput(a,this):a.hasClass("file")&&this.initFileInput(a,this)},initCheckboxInput:function(a,b){},initFileInput:function(a,b){var d,e,f;f=c("<input type='text' id='__input_file_wrapper__' readonly style='z-index: 1; cursor: default;'>");
