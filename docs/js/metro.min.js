(function(c){c.Metro=function(a){c.extend({},a)};c.Metro.initAccordions=function(){c("[data-role=accordion]").accordion()};c.Metro.initButtonSets=function(){c("[data-role=button-set]").buttonset();c("[data-role=button-group]").buttongroup()};c.Metro.initCalendars=function(){c("[data-role=calendar]").calendar()};c.Metro.initCarousels=function(){c("[data-role=carousel]").carousel()};c.Metro.initCountdowns=function(){c("[data-role=countdown]").countdown()};c.Metro.initDatepickers=function(){c("[data-role=datepicker]").datepicker()};
...
function(){c("[data-role=stepper]").stepper()};c.Metro.initStreamers=function(){c("[data-role=streamer]").streamer()};c.Metro.initDragTiles=function(){c("[data-role=drag-drop]").dragtile()}})(jQuery);var hasTouch="ontouchend"in window,eventTimer,moveDirection="undefined",startX,startY,deltaX,deltaY,mouseDown=!1;function addTouchEvents(c){hasTouch&&(c.addEventListener("touchstart",touch2Mouse,!0),c.addEventListener("touchmove",touch2Mouse,!0),c.addEventListener("touchend",touch2Mouse,!0))}
...
b){this._super("_setOption",a,b)}})})(jQuery);$(function(){$("[data-role=button-set]").buttonset();$("[data-role=button-group]").buttongroup()});var dateFormat=function(){var c=/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,a=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,b=/[^-+\dA-Z]/g,d=function(a,b){a=String(a);for(b=b||2;a.length<b;)a="0"+a;return a};return function(e,f,g){var h=dateFormat;1!=arguments.length||("[object String]"!=Object.prototype.toString.call(e)||/\d/.test(e))||(f=e,e=void 0);e=e?new Date(e):new Date;f=String(h.masks[f]||
f||h.masks["default"]);"UTC:"==f.slice(0,4)&&(f=f.slice(4),g=!0);var k=g?"getUTC":"get",l=e[k+"Date"](),s=e[k+"Day"](),m=e[k+"Month"](),p=e[k+"FullYear"](),n=e[k+"Hours"](),t=e[k+"Minutes"](),u=e[k+"Seconds"](),k=e[k+"Milliseconds"](),r=g?0:e.getTimezoneOffset(),q={d:l,dd:d(l),ddd:h.i18n.dayNames[s],dddd:h.i18n.dayNames[s+7],m:m+1,mm:d(m+1),mmm:h.i18n.monthNames[m],mmmm:h.i18n.monthNames[m+12],yy:String(p).slice(2),yyyy:p,h:n%12||12,hh:d(n%12||12),H:n,HH:d(n),M:t,MM:d(t),s:u,ss:d(u),l:d(k,3),L:d(99<
k?Math.round(k/10):k),t:12>n?"a":"p",tt:12>n?"am":"pm",T:12>n?"A":"P",TT:12>n?"AM":"PM",Z:g?"UTC":(String(e).match(a)||[""]).pop().replace(b,""),o:(0<r?"-":"+")+d(100*Math.floor(Math.abs(r)/60)+Math.abs(r)%60,4),S:["th","st","nd","rd"][3<l%10?0:(10!=l%100-l%10)*l%10]};return f.replace(c,function(a){return a in q?q[a]:a.slice(1,a.length-1)})}}();
dateFormat.masks={"default":"ddd mmm dd yyyy HH:MM:ss",shortDate:"m/d/yy",mediumDate:"mmm d, yyyy",longDate:"mmmm d, yyyy",fullDate:"dddd, mmmm d, yyyy",shortTime:"h:MM TT",mediumTime:"h:MM:ss TT",longTime:"h:MM:ss TT Z",isoDate:"yyyy-mm-dd",isoTime:"HH:MM:ss",isoDateTime:"yyyy-mm-dd'T'HH:MM:ss",isoUtcDateTime:"UTC:yyyy-mm-dd'T'HH:MM:ss'Z'"};dateFormat.i18n={dayNames:"Sun Mon Tue Wed Thu Fri Sat Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),monthNames:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec January February March April May June July August September October November December".split(" ")};
Date.prototype.format=function(c,a){return dateFormat(this,c,a)};(function(c){c.widget("metro.calendar",{version:"1.0.0",options:{format:"yyyy-mm-dd",multiSelect:!1,startMode:"day",months:"January; February;March;April;May;June;July;August;September;October;November;December".split(";"),monthsShort:"Jan; Feb;Mar;Apr;May;Jun;Jul;Aug;Sep;Oct;Nov;Dec".split(";"),weekDays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),buttonsNames:["Today","Clear"],date:new Date,buttons:!0,getDates:function(a){},click:function(a,b){},_storage:[]},_year:0,_month:0,_day:0,_today:new Date,
...
this.options.date.getFullYear();this._distance=parseInt(this.options.date.getFullYear())-4;this._month=this.options.date.getMonth();this._day=this.options.date.getDate();this._mode=this.options.startMode;a.data("_storage",[]);this._renderCalendar()},_renderMonth:function(){var a=this._year,b=this._month,d=28;1==b&&(0!=a%100&&0==a%4||0==a%400)&&(d=29);var d=["31",""+d+"","31","30","31","30","31","31","30","31","30","31"][b],e=(new Date(a,b,1)).getDay(),f,g,h;this.element.html("");f=c("<table/>").addClass("bordered");
g=c("<tr/>");c("<td/>").addClass("text-center").html("<a class='btn-previous-year' href='#'><i class='icon-previous'></i></a>").appendTo(g);c("<td/>").addClass("text-center").html("<a class='btn-previous-month' href='#'><i class='icon-arrow-left-4'></i></a>").appendTo(g);c("<td/>").attr("colspan",3).addClass("text-center").html("<a class='btn-select-month' href='#'>"+this.options.months[b]+" "+a+"</a>").appendTo(g);c("<td/>").addClass("text-center").html("<a class='btn-next-month' href='#'><i class='icon-arrow-right-4'></i></a>").appendTo(g);
c("<td/>").addClass("text-center").html("<a class='btn-next-year' href='#'><i class='icon-next'></i></a>").appendTo(g);g.addClass("calendar-header").appendTo(f);g=c("<tr/>");for(h=0;7>h;h++)c("<td/>").addClass("text-center day-of-week").html(this.options.weekDays[h]).appendTo(g);g.addClass("calendar-subheader").appendTo(f);g=c("<tr/>");for(h=0;h<e;h++)c("<td/>").addClass("empty").html("").appendTo(g);var k=e;for(h=1;h<=d;h++){k%=7;0==k&&(g.appendTo(f),g=c("<tr/>"));e=c("<td/>").addClass("text-center day").html("<a href='#'>"+
h+"</a>");a==this._today.getFullYear()&&(b==this._today.getMonth()&&this._today.getDate()==h)&&e.addClass("today");var l=(new Date(this._year,this._month,h)).format("yyyy-mm-dd");0<=this.element.data("_storage").indexOf(l)&&e.find("a").addClass("selected");e.appendTo(g);k++}for(h=k+1;7>=h;h++)c("<td/>").addClass("empty").html("").appendTo(g);g.appendTo(f);this.options.buttons&&(g=c("<tr/>").addClass("calendar-actions"),e=c("<td/>").attr("colspan",7).addClass("text-left").html("<button class='button calendar-btn-today small success'>"+
this.options.buttonsNames[0]+"</button>&nbsp;<button class='button calendar-btn-clear small warning'>"+this.options.buttonsNames[1]+"</button>"),e.appendTo(g),g.appendTo(f));f.appendTo(this.element);this.options.getDates(this.element.data("_storage"))},_renderMonths:function(){var a,b,d,e,f;this.element.html("");a=c("<table/>").addClass("bordered");b=c("<tr/>");c("<td/>").addClass("text-center").html("<a class='btn-previous-year' href='#'><i class='icon-arrow-left-4'></i></a>").appendTo(b);c("<td/>").attr("colspan",
2).addClass("text-center").html("<a class='btn-select-year' href='#'>"+this._year+"</a>").appendTo(b);c("<td/>").addClass("text-center").html("<a class='btn-next-year' href='#'><i class='icon-arrow-right-4'></i></a>").appendTo(b);b.addClass("calendar-header").appendTo(a);b=c("<tr/>");for(e=f=0;12>e;e++)d=c("<td/>").addClass("text-center month").html("<a href='#' data-month='"+e+"'>"+this.options.monthsShort[e]+"</a>"),this._month==e&&(new Date).getFullYear()==this._year&&d.addClass("today"),d.appendTo(b),
0==(f+1)%4&&(b.appendTo(a),b=c("<tr/>")),f+=1;a.appendTo(this.element)},_renderYears:function(){var a,b,d,e,f;this.element.html("");a=c("<table/>").addClass("bordered");b=c("<tr/>");c("<td/>").addClass("text-center").html("<a class='btn-previous-year' href='#'><i class='icon-arrow-left-4'></i></a>").appendTo(b);c("<td/>").attr("colspan",2).addClass("text-center").html(this._distance+"-"+(this._distance+11)).appendTo(b);c("<td/>").addClass("text-center").html("<a class='btn-next-year' href='#'><i class='icon-arrow-right-4'></i></a>").appendTo(b);
b.addClass("calendar-header").appendTo(a);b=c("<tr/>");f=0;for(e=this._distance;e<this._distance+12;e++)d=c("<td/>").addClass("text-center year").html("<a href='#' data-year='"+e+"'>"+e+"</a>"),(new Date).getFullYear()==e&&d.addClass("today"),d.appendTo(b),0==(f+1)%4&&(b.appendTo(a),b=c("<tr/>")),f+=1;a.appendTo(this.element)},_renderCalendar:function(){switch(this._mode){case "year":this._renderYears();break;case "month":this._renderMonths();break;default:this._renderMonth()}this._initButtons()},
...
b.find(".calendar-btn-clear").on("click",function(b){b.preventDefault();b.stopPropagation();a.options.date=new Date;a._year=a.options.date.getFullYear();a._month=a.options.date.getMonth();a._day=a.options.date.getDate();a.element.data("_storage",[]);a._renderCalendar()}),b.find(".day a").on("click",function(d){d.preventDefault();d.stopPropagation();d=(new Date(a._year,a._month,parseInt(c(this).html()))).format(a.options.format);var e=new Date(a._year,a._month,parseInt(c(this).html()));a.options.multiSelect?
(c(this).toggleClass("selected"),c(this).hasClass("selected")?a._addDate(d):a._removeDate(d)):(b.find(".day a").removeClass("selected"),c(this).addClass("selected"),a.element.data("_storage",[]),a._addDate(d));a.options.getDates(a.element.data("_storage"));a.options.click(d,e)})):"month"==this._mode?(b.find(".month a").on("click",function(b){b.preventDefault();b.stopPropagation();a._month=parseInt(c(this).data("month"));a._mode="day";a._renderCalendar()}),b.find(".btn-previous-year").on("click",function(b){b.preventDefault();
b.stopPropagation();a._year-=1;a._renderCalendar()}),b.find(".btn-next-year").on("click",function(b){b.preventDefault();b.stopPropagation();a._year+=1;a._renderCalendar()}),b.find(".btn-select-year").on("click",function(b){b.preventDefault();b.stopPropagation();a._mode="year";a._renderCalendar()})):(b.find(".year a").on("click",function(b){b.preventDefault();b.stopPropagation();a._year=parseInt(c(this).data("year"));a._mode="month";a._renderCalendar()}),b.find(".btn-previous-year").on("click",function(b){b.preventDefault();
...
this._addDate(a);this._renderCalendar()},getDate:function(a){return(new Date(void 0!=a?this.element.data("_storage")[a]:this.element.data("_storage")[0])).format(this.options.format)},getDates:function(){return this.element.data("_storage")},unsetDate:function(a){a=new Date(a);a=(new Date(a.getFullYear()+"-"+(a.getMonth()+1)+"-"+a.getDate())).format("yyyy-mm-dd");this._removeDate(a);this._renderCalendar()},_destroy:function(){},_setOption:function(a,b){this._super("_setOption",a,b)}})})(jQuery);$(function(){$("[data-role=calendar]").calendar()});(function(c){c.widget("metro.datepicker",{version:"1.0.0",options:{format:"dd.mm.yyyy",date:void 0,effect:"none",position:"bottom",selected:function(a,b){},_calendar:void 0},_create:function(){var a=this,b=this.element,d=b.children("input"),e=b.children("button.btn-date");void 0!=b.data("date")&&(this.options.date=b.data("date"));void 0!=b.data("format")&&(this.options.format=b.data("format"));void 0!=b.data("effect")&&(this.options.effect=b.data("effect"));void 0!=b.data("position")&&(this.options.position=
b.data("position"));this._createCalendar(b,this.options.date);d.attr("readonly",!0);e.on("click",function(b){b.stopPropagation();"none"==a.options._calendar.css("display")?a._show():a._hide()});b.on("click",function(b){b.stopPropagation();"none"==a.options._calendar.css("display")?a._show():a._hide()});c("html").on("click",function(a){c(".calendar-dropdown").hide()})},_createCalendar:function(a,b){var d,e=this;d=c("<div/>").css({position:"absolute",display:"none","max-width":260,"z-index":1E3}).addClass("calendar calendar-dropdown").appendTo(a);
void 0!=e.options.date&&d.data("date",e.options.date);d.calendar({multiSelect:!1,format:e.options.format,buttons:!1,click:function(b,c){d.calendar("setDate",c);a.children("input[type=text]").val(b);e.options.selected(b,c);e._hide()}});void 0!=b&&(d.calendar("setDate",b),a.children("input[type=text]").val(d.calendar("getDate")));switch(this.options.position){case "top":d.css({top:0-d.height(),left:0});break;default:d.css({top:"100%",left:0})}this.options._calendar=d},_show:function(){"slide"==this.options.effect?
(c(".calendar-dropdown").slideUp("fast"),this.options._calendar.slideDown("fast")):"fade"==this.options.effect?(c(".calendar-dropdown").fadeOut("fast"),this.options._calendar.fadeIn("fast")):(c(".calendar-dropdown").hide(),this.options._calendar.show())},_hide:function(){"slide"==this.options.effect?this.options._calendar.slideUp("fast"):"fade"==this.options.effect?this.options._calendar.fadeOut("fast"):this.options._calendar.hide()},_destroy:function(){},_setOption:function(a,b){this._super("_setOption",
a,b)}})})(jQuery);$(function(){$("[data-role=datepicker]").datepicker()});(function(c){c.widget("metro.carousel",{version:"1.0.0",options:{auto:!0,period:2E3,duration:500,effect:"slowdown",direction:"left",markers:{show:!0,type:"default",position:"left"},controls:!0,stop:!0,width:"100%",height:300},_slides:{},_currentIndex:0,_interval:0,_outPosition:0,_create:function(){var a=this,b=this.options,d=carousel=this.element,c=carousel.find(".controls");void 0!=d.data("auto")&&(b.auto=d.data("auto"));void 0!=d.data("period")&&(b.period=d.data("period"));void 0!=d.data("duration")&&
...
this.element,b=c("<div/>").addClass("input-control").addClass("textarea"),d=a.clone(!0),e=a.parent();b.appendTo(e);d.appendTo(b);a.remove();return b},_createInputSelect:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("select"),d=a.clone(!0),e=a.parent();b.appendTo(e);d.val(a.val()).appendTo(b);a.remove();return b},_createInputSwitch:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("switch"),d=c("<label/>"),e=c("<span/>").addClass("check"),
f=a.clone(!0),g=a.parent(),h=c("<span/>").addClass("caption").html(void 0!=a.data("caption")?a.data("caption"):"");b.appendTo(g);d.appendTo(b);f.appendTo(d);e.appendTo(d);h.appendTo(d);a.remove();return b},_createInputCheckbox:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("checkbox"),d=c("<label/>"),e=c("<span/>").addClass("check"),f=a.clone(!0),g=a.parent(),h=c("<span/>").addClass("caption").html(void 0!=a.data("caption")?a.data("caption"):"");b.appendTo(g);d.appendTo(b);
f.appendTo(d);e.appendTo(d);h.appendTo(d);a.remove();return b},_createInputRadio:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("radio"),d=c("<label/>"),e=c("<span/>").addClass("check"),f=a.clone(!0),g=a.parent(),h=c("<span/>").addClass("caption").html(void 0!=a.data("caption")?a.data("caption"):"");b.appendTo(g);d.appendTo(b);f.appendTo(d);e.appendTo(d);h.appendTo(d);a.remove();return b},_createInputSearch:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("text"),
d=c("<button/>").addClass("btn-search"),e=a.clone(!0),f=a.parent();b.appendTo(f);e.appendTo(b);d.appendTo(b);a.remove();return b},_createInputTel:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("tel"),d=c("<button/>").addClass("btn-clear"),e=a.clone(!0),f=a.parent();b.appendTo(f);e.appendTo(b);d.appendTo(b);a.remove();return b},_createInputEmail:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("email"),d=c("<button/>").addClass("btn-clear"),
e=a.clone(!0),f=a.parent();b.appendTo(f);e.appendTo(b);d.appendTo(b);a.remove();return b},_createInputText:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("text"),d=c("<button/>").addClass("btn-clear"),e=a.clone(!0),f=a.parent();b.appendTo(f);e.appendTo(b);d.appendTo(b);a.remove();return b},_createInputPassword:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("password"),d=c("<button/>").addClass("btn-reveal"),e=a.clone(!0),f=a.parent();
b.appendTo(f);e.appendTo(b);d.appendTo(b);a.remove();return b},_createInputFile:function(){var a=this.element,b=c("<div/>").addClass("input-control").addClass("file"),d=c("<button/>").addClass("btn-file"),e=a.clone(!0),f=a.parent();b.appendTo(f);e.appendTo(b);d.appendTo(b);a.remove();return b},_destroy:function(){},_setOption:function(a,b){this._super("_setOption",a,b)}})})(jQuery);$(function(){$("[data-transform=input-control]").inputTransform()});(function(c){c.widget("metro.livetile",{version:"1.0.0",options:{effect:"slideLeft",period:4E3,duration:700,easing:"doubleSqrt"},_frames:{},_currentIndex:0,_interval:0,_outPosition:0,_size:{},_create:function(){var a=this.element;void 0!=a.data("effect")&&(this.options.effect=a.data("effect"));void 0!=a.data("direction")&&(this.options.direction=a.data("direction"));void 0!=a.data("period")&&(this.options.period=a.data("period"));void 0!=a.data("duration")&&(this.options.duration=a.data("duration"));
void 0!=a.data("easing")&&(this.options.easing=a.data("easing"));this._frames=a.children("[class*='-content']");1>=this._frames.length||(c.easing.doubleSqrt=function(a){return Math.sqrt(Math.sqrt(a))},this._size={width:a.width(),height:a.height()},this._start())},_start:function(){var a=this;this._interval=setInterval(function(){a._animate()},this.options.period)},_animate:function(){var a=this._frames[this._currentIndex],b;this._currentIndex+=1;this._currentIndex>=this._frames.length&&(this._currentIndex=
...
e.outerWidth())/2);addTouchEvents(e[0]);if(b.draggable)f.on("mousedown",function(a){c.Dialog.drag=!0;f.css("cursor","move");var b=e.css("z-index"),d=e.outerHeight(),g=e.outerWidth(),m=e.offset().top+d-a.pageY,p=e.offset().left+g-a.pageX;e.css("z-index",99999).parents().on("mousemove",function(a){var h=0<a.pageY?a.pageY+m-d:0;a=0<a.pageX?a.pageX+p-g:0;c.Dialog.drag&&(0<=h&&h<=window.innerHeight-e.outerHeight()&&e.offset({top:h}),0<=a&&a<=window.innerWidth-e.outerWidth()&&e.offset({left:a}));e.on("mouseup",
